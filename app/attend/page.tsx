          ...
          <Tabs defaultValue="why-attend" className="mb-12">
            ...
            <TabsContent value="why-attend" className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed text-center mb-8">
                The Global FinTech Summit & Awards offers you the opportunity to network with the most prominent leaders
            ...
            <TabsContent value="networking" className="space-y-6">
              ...
              >
                ...
                >
                  Forge Meaningful Connections at Global FinTech Summit & Awards
                </motion.h3>
                    ...
                    <ul className="space-y-4 text-black">
                      <li className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Meet Top Fintech Leaders: The Global FinTech Summit & Awards gathers 250+ attendees, including
